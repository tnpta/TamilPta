...
export interface RegistrationTranslations {
  ...
  feesOthers: {
    ...
    sufficientFeesFixation: string;
    ptaConsulted: string;
    ptaConsultationDetails: string;
    feesCollected: string;
    feesFixedByCommittee: string;
    ...
    otherDetails: string;
    lastYearAudit: string;
    last3YearsAudit: string;
    healthCare: string;
    ...
    expenseCategories: {
      teachingSalary: string;
      nonTeachingSalary: string;
      ebBill: string;
      miscExpenses: string;
      transportExp: string;
      buildingMaintenance: string;
      booksPurchase: string;
      advertisement: string;
      propertyTax: string;
      softwareDigital: string;
